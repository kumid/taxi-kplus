...
import { EditComponent } from "./UpdateLoanCardMobile";
...
const UpdateLoanCard: React.FC<CardProps> = ({ element, updateElement }) => {
  ...
  return (
    <>
      <View style={styles.container}>
        <Text style={{ margin: 20, fontSize: 22, fontWeight: 500 }}>{title}</Text>
        ...
        <View style={{ marginStart: 10 }}>
          <EditComponent label={"Детали предложения"} placeholder={"Детали предложения"} value={offerDetail} onChangeText={setOfferDetail} style={{ width: '100%' }} />
        </View>

        <View style={{marginStart: 10 }}>
          <EditComponent label={"Лого"} placeholder={"https://"} value={image} onChangeText={setImage} style={{ width: '100%'  }} />
        </View>
 
        <View style={{  marginStart: 10 }}>
          <EditComponent label={"Сайт"} placeholder={"Сайт"} value={site} onChangeText={setSite} style={{ width: '100%' }} />
        </View>
